...
<head>
    ...
    <style>
        ...
        .task-container {
            ...
            width: 40%; /* Sesuaikan lebarnya jika diperlukan */
            margin: 10px;
            vertical-align: top;
            border: 1px;
            background-color: #FCBC58;
            border-radius: 20px;
            box-shadow: 0 20px 50px rgba(0, 0, 0, 0.1); /* Tambahkan box-shadow untuk memberikan efek bayangan */
            padding: 20px;
        }
        ...
        .container .task-container:first-child {
            margin-top: 50px; /* Memberikan margin-top pada task-container pertama dan kedua di dalam container */
        }
...
<body>
    ...
    <div class="container">
        ...
        ?>
            ...
            <div class="task">
                <label>
                    ...
                    <input type="checkbox" <?php echo $task['completed'] ? 'checked' : ''; ?> onchange="updateTaskStatus(<?php echo $task['id_tasks']; ?>, <?php echo $task['completed']; ?>)">
        ...
        ?>
        </div> <!-- Tutup kontainer tugas terakhir -->
    </div>
    ...
    <!-- Script untuk mengatur visibilitas navbar -->
    <script>
        ...
        timeout = setTimeout(function() {
            isScrolling = false;
            hideNavbar();
        }, 2000); // Deteksi berhentinya scroll setelah 200ms
        }

        // Periksa apakah pointer berada di atas navbar
