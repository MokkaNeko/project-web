    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Add Jadwal Button -->
                <div class="mb-4">
                    <button class="btn btn-primary" data-toggle="modal" data-target="#addJadwalModal">Tambah Data</button>
                </div>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered" id="jadwalTable" width="100%" cellspacing="0">
                        ...
                        <?php
                            ...
                            $sql = "SELECT id_mata_pelajaran, nama, hari, waktu, guru FROM mata_pelajaran";
                ...
                <!-- Delete Jadwal Modal -->
                <div class="modal fade" id="deleteJadwalModal" tabindex="-1" role="dialog" aria-labelledby="deleteJadwalModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                    <div class="modal-header">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; MyClass 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
