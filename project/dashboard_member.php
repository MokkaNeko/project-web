<?php
// Start the PHP session to manage user sessions
session_start();
...
<!-- Main Content Area -->
<div class="content">
    <h2>Hi!<span><?php echo $_SESSION['username']?></span></h2>
...
<script>
  ...
  function logout() {
    // Display an alert for logout (you may replace this with your actual logout functionality)
    alert("Logout");
