...
<body>
    ...
    if (isset($_POST['insert'])) {
        ...
        $stmt = $conn->prepare("insert into jadwal_pelajaran (mapel, guru, hari, waktu) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("ssss", $mapel, $guru, $previousHari, $waktu);
    ...
    ?>
        ...
        <h1>Tambah Jadwal Pelajaran Baru</h1>
        ...
        <form method="POST" action="">
            ...
            <input type="text" name="guru" required><br>
