          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <a href="admin/admin.php" class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <?php
                                            ...
                                            if ($conn) {
                                                // Query to get the count of admins from the 'user' table
                                                $query = "SELECT COUNT(*) AS admin_count FROM `user` WHERE `status` = 'admin'";
                                                ...
                                                if ($result && mysqli_num_rows($result) > 0) {
                                                    ...
                                                    echo '<div class="h5 mb-0 font-weight-bold text-gray-800">' . $admin_count . '</div>';
                                                } else {
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <?php
                                            // Replace 'your_database_credentials' with the actual database connection details
                                            $conn = mysqli_connect("localhost", "root", "", "class");

                                            // Check if the connection was successful
                                            if ($conn) {
                                                // Query to get the count of users from the 'user' table
                                                $query = "SELECT COUNT(*) AS siswa_count FROM `user` WHERE `status` = 'member'";
                                                $result = mysqli_query($conn, $query);

                                                if ($result && mysqli_num_rows($result) > 0) {
                                                    // Fetch the user count
                                                    $row = mysqli_fetch_assoc($result);
                                                    $siswa_count = $row['siswa_count'];
                                                    echo '<div class="h5 mb-0 font-weight-bold text-gray-800">' . $siswa_count . '</div>';
                                                } else {
                                                    echo '<div class="h5 mb-0 font-weight-bold text-gray-800">0</div>';
                                                }
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <?php
                                            ...
                                            // Check if the connection was successful
                                            if ($conn) {
                                                // Query to get the count of tasks from the 'tasks' table
                                                ...
                                                if ($result && mysqli_num_rows($result) > 0) {
                                                    ...
                                                    echo '<div class="h5 mb-0 font-weight-bold text-gray-800">' . $task_count . '</div>';
                                                } else {
                                                    echo '<div class="h5 mb-0 font-weight-bold text-gray-800">0</div>';
                                                }
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Classy Class System 2023</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
