        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="mb-4">
                        <button class="btn btn-primary" data-toggle="modal" data-target="#addJadwalPiketModal">Jadwal
                            Data</button>
                    </div>
                    ...
                    <div class="modal fade" id="addJadwalPiketModal" tabindex="-1" role="dialog"
                        aria-labelledby="addJadwalPiketModalLabel" aria-hidden="true">
                ...
                <div class="modal fade" id="editJadwalPiketModal" tabindex="-1" role="dialog"
                    aria-labelledby="editJadwalPiketModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                ...
                <div class="modal fade" id="deleteJadwalPiketModal" tabindex="-1" role="dialog"
                    aria-labelledby="deleteJadwalPiketModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
